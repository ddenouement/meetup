...
var RegisterSpeakerComponent = /** @class */ (function () {
    ...
    RegisterSpeakerComponent.prototype.register = function () {
        var speaker = { login: this.login, email: this.email, password: this.password, name: this.name, surname: this.surname, nativeLanguage: this.nativeLanguage };
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.register = function () {
        var listener = { login: this.login, email: this.email, password: this.password };
...
module.exports = __webpack_require__(/*! D:\NBprojects\currentProject\nc-autumn-2019\frontend\src\main.ts */"./src/main.ts");
